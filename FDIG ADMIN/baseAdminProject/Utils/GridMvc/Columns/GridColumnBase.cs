...
namespace GridMvc.Columns
{
    ...
    {
        protected Func<T, IGridColumn<T>, string> ValueConstraint;
        ...
        public IGridColumn<T> RenderValueAs(Func<T, IGridColumn<T>, string> constraint)
        {
        ...
        //!@NIMOK
        public IGridColumn<T> SetDataIndex(int dataIndex)
        {
            DataIndex = dataIndex;
            return this;
        }
